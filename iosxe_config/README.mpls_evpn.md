...
![DAG経由の通信可否](img/dag_restriction.drawio.png)

このような制約がありますので、使い勝手の観点でいうと、PE装置において自分から自分に戻るような物理結線をしたうえで、EVPNとL3VPNを物理結線として相互接続した方が便利かもしれません。

制限事項はもうちょっと調査が必要ですが、少なくともドキュメント上は以下のように記載されています。
